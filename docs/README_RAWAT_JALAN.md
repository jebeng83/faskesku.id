...
### 4. Pewarnaan Baris Tabel
Pewarnaan baris mengikuti nilai `reg_periksa.stts` pada setiap baris. Baris akan berwarna putih saat status bernilai `Belum` untuk menandai kunjungan yang belum diproses. Daftar status dan kelas warna:
...
- Belum: `bg-white dark:bg-white hover:bg-gray-50 dark:hover:bg-gray-100` (baris putih untuk status belum)
