...
class SettingController extends Controller
{
    ...
    public function getActiveSetting()
    {
        try {
            ...
            if ($setting->logo) {
                $data['logo_url'] = route('settings.image', ['setting' => $setting->nama_instansi, 'type' => 'logo']);
            }

            if ($setting->wallpaper) {
                $data['wallpaper_url'] = route('settings.image', ['setting' => $setting->nama_instansi, 'type' => 'wallpaper']);
            }
