...
return new class extends Migration
{
    ...
    public function up(): void
    {
        if (!Schema::hasTable('pcare_rujuk_khusus')) {
            Schema::create('pcare_rujuk_khusus', function (Blueprint $table) {
                ...
                $table->char('kdKhusus', 5)->nullable();
                $table->string('nmKhusus', 50)->nullable();
                $table->char('kdSubSpesialis', 5)->nullable();
    ...
    {
        Schema::dropIfExists('pcare_rujuk_khusus');
    }
};
