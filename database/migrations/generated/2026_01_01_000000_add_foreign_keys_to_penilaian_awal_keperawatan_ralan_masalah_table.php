...
return new class extends Migration
{
    ...
    {
        if (Schema::hasTable('penilaian_awal_keperawatan_ralan_masalah')) {
            Schema::table('penilaian_awal_keperawatan_ralan_masalah', function (Blueprint $table) {
                $table->foreign(['no_rawat'], 'penilaian_awal_keperawatan_ralan_masalah_ibfk_1')->references(['no_rawat'])->on('penilaian_awal_keperawatan_ralan')->onUpdate('cascade')->onDelete('cascade');
