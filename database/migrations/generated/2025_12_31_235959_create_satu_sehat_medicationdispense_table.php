...
return new class extends Migration
{
    ...
    public function up(): void
    {
        if (! Schema::hasTable('satu_sehat_medicationdispense')) {
            Schema::create('satu_sehat_medicationdispense', function (Blueprint $table) {
                ...
                $table->string('id_medicationdispanse', 40)->nullable();
    ...
    {
        Schema::dropIfExists('satu_sehat_medicationdispense');
    }
};
