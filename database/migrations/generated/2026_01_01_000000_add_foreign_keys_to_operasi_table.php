...
return new class extends Migration
{
    ...
    {
        if (Schema::hasTable('operasi')) {
            Schema::table('operasi', function (Blueprint $table) {
                $table->foreign(['no_rawat'], 'operasi_ibfk_31')->references(['no_rawat'])->on('reg_periksa')->onUpdate('cascade')->onDelete('restrict');
                ...
                $table->foreign(['dokter_anestesi'], 'operasi_ibfk_40')->references(['kd_dokter'])->on('dokter')->onUpdate('cascade')->onDelete('restrict');
                ...
                $table->foreign(['kode_paket'], 'operasi_ibfk_44')->references(['kode_paket'])->on('paket_operasi')->onUpdate('cascade')->onDelete('restrict');
