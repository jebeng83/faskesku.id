...
return new class extends Migration
{
    ...
    {
        if (Schema::hasTable('ipsrs_detail_returbeli')) {
            Schema::table('ipsrs_detail_returbeli', function (Blueprint $table) {
                $table->foreign(['kode_sat'], 'ipsrs_detail_returbeli_ibfk_1')->references(['kode_sat'])->on('kodesatuan')->onUpdate('cascade')->onDelete('restrict');
