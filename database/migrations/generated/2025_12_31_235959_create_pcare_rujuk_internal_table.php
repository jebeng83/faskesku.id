...
return new class extends Migration
{
    ...
    public function up(): void
    {
        if (!Schema::hasTable('pcare_rujuk_internal')) {
            Schema::create('pcare_rujuk_internal', function (Blueprint $table) {
                ...
                $table->char('kdPoliRujukInternal', 5)->nullable();
                $table->string('nmPoliRujukInternal', 50)->nullable();
    ...
    {
        Schema::dropIfExists('pcare_rujuk_internal');
    }
};
