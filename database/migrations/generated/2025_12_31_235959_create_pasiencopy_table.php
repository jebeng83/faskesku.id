...
return new class extends Migration
{
    ...
    {
        if (! Schema::hasTable('pasiencopy')) {
            Schema::create('pasiencopy', function (Blueprint $table) {
                ...
                $table->index(['no_rkm_medis', 'nm_pasien'], 'idx_pasien_rkm_nama');
            });
        }
    }
    ...
    {
        Schema::dropIfExists('pasiencopy');
    }
};
