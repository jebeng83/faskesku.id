    ...
    public function up(): void
    {
        if (!Schema::hasTable('asuhan_gizi')) {
            Schema::create('asuhan_gizi', function (Blueprint $table) {
                ...
                $table->string('biokimia', 1000)->nullable();
                $table->string('fisik_klinis', 2000)->nullable();
                ...
                $table->string('pola_makan', 2000)->nullable();
                $table->string('riwayat_personal', 1000)->nullable();
                $table->string('diagnosis', 2000)->nullable();
                $table->string('intervensi_gizi', 2000)->nullable();
                $table->string('monitoring_evaluasi', 1000)->nullable();
