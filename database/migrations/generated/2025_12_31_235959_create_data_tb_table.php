    ...
    public function up(): void
    {
        if (!Schema::hasTable('data_tb')) {
            Schema::create('data_tb', function (Blueprint $table) {
                ...
                $table->enum('sebelum_pengobatan_hasil_mikroskopis', ['Negatif', '1-19', '1+', '2+', '3+', 'Tidak dilakukan'])->nullable();
                ...
                $table->enum('hasil_mikroskopis_bulan_2', ['Negatif', '1-19', '1+', '2+', '3+', 'Tidak dilakukan'])->nullable();
                $table->string('noreglab_bulan_3', 15)->nullable();
                $table->enum('hasil_mikroskopis_bulan_3', ['Negatif', '1-19', '1+', '2+', '3+', 'Tidak dilakukan'])->nullable();
                $table->string('noreglab_bulan_5', 15)->nullable();
                $table->enum('hasil_mikroskopis_bulan_5', ['Negatif', '1-19', '1+', '2+', '3+', 'Tidak dilakukan'])->nullable();
                $table->string('akhir_pengobatan_noreglab', 15)->nullable();
                $table->enum('akhir_pengobatan_hasil_mikroskopis', ['Negatif', '1-19', '1+', '2+', '3+', 'Tidak dilakukan'])->nullable();
                $table->date('tanggal_hasil_akhir_pengobatan')->nullable();
                $table->enum('hasil_akhir_pengobatan', ['Belum', 'Sembuh', 'Pengobatan Lengkap', 'Lost To Follow Up', 'Meninggal', 'Gagal', 'Pindah', ''])->nullable();
                ...
                $table->string('kode_icd_x', 15)->nullable()->index('kode_icd_x');
            });
        }
    }
