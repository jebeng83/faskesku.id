...
return new class extends Migration
{
    ...
    public function up(): void
    {
        if (!Schema::hasTable('penilaian_medis_ranap_psikiatrik')) {
            Schema::create('penilaian_medis_ranap_psikiatrik', function (Blueprint $table) {
                ...
                $table->string('skala_penilaian_khusus', 200);
    ...
    {
        Schema::dropIfExists('penilaian_medis_ranap_psikiatrik');
    }
};
