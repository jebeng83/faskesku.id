...
return new class extends Migration
{
    ...
    {
        if (!Schema::hasTable('temporary_permintaan_labmb')) {
            Schema::create('temporary_permintaan_labmb', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('temporary_permintaan_labmb');
    }
};
