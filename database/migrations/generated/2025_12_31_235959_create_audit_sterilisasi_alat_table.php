...
return new class extends Migration
{
    ...
    public function up(): void
    {
        if (! Schema::hasTable('audit_sterilisasi_alat')) {
            Schema::create('audit_sterilisasi_alat', function (Blueprint $table) {
                ...
                $table->enum('audit10', ['Ya', 'Tidak']);
                $table->enum('audit11', ['Ya', 'Tidak']);
    ...
    {
        Schema::dropIfExists('audit_sterilisasi_alat');
    }
};
