...
return new class extends Migration
{
    ...
    {
        if (! Schema::hasTable('penilaian_awal_keperawatan_mata')) {
            Schema::create('penilaian_awal_keperawatan_mata', function (Blueprint $table) {
                ...
                $table->string('visuskanan', 20);
                $table->string('visuskiri', 20);
                $table->string('refraksikanan', 20);
                $table->string('refraksikiri', 20);
                $table->string('tiokanan', 20);
                $table->string('tiokiri', 20);
                $table->string('palberakanan', 20);
                $table->string('palberakiri', 20);
                $table->string('konjungtivakanan', 20);
                $table->string('konjungtivakiri', 20);
                $table->string('sklerakanan', 20);
                $table->string('sklerakiri', 20);
                $table->string('korneakanan', 20);
                $table->string('korneakiri', 20);
                $table->string('bmdkanan', 20);
                $table->string('bmdkiri', 20);
                $table->string('iriskanan', 20);
                $table->string('iriskiri', 20);
                $table->string('pupilkanan', 20);
                $table->string('pupilkiri', 20);
                $table->string('lensakanan', 20);
                $table->string('lensakiri', 20);
                $table->string('oftalmoskopikanan', 100);
                $table->string('oftalmoskopikiri', 100);
    ...
    {
        Schema::dropIfExists('penilaian_awal_keperawatan_mata');
    }
};
