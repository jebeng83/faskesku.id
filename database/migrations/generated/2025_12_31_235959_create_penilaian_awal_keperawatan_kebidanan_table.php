    ...
    public function up(): void
    {
        if (! Schema::hasTable('penilaian_awal_keperawatan_kebidanan')) {
            Schema::create('penilaian_awal_keperawatan_kebidanan', function (Blueprint $table) {
                ...
                $table->enum('kb', ['Belum Pernah', 'Suntik', 'Pil', 'AKDR', 'MOW', 'Implan', 'Kondom', 'Kalender', 'MAL', 'Coitus Interuptus']);
                ...
                $table->enum('sg1', ['Ya', 'Tidak', 'Tidak Yakin', 'Ya, 1-5 Kg', 'Ya, 6-10 Kg', 'Ya, 11-15 Kg', 'Ya, >15 Kg']);
