...
public class DlgUpdateUser extends javax.swing.JDialog {
    ...
    private boolean penyakit=false,obat_penyakit=false,dokter=false,jadwal_praktek=false,petugas=false,pasien=false,registrasi=false,tindakan_ralan=false,kamar_inap=false,
            ...
            skrining_adiksi_nikotin=false,skrining_thalassemia=false,skrining_instrumen_sdq=false,surat_kirnikah=false,data_sasaran_usiabayi=false,data_sasaran_usiabalita=false,riwayat_perawatan_icare_fktp=false,
            data_sasaran_usiaprasekolah=false,data_sasaran_usiaremaja=false;
    ...
    */
    ...
    private void tampil(String user) {  
        ...
        skrining_risiko_kanker_payudara=false;skrining_risiko_kanker_paru=false;skrining_tbc=false;skrining_kesehatan_gigi_mulut_remaja=false;penilaian_awal_keperawatan_ranap_bayi=false;booking_mcu_perusahaan=false;
        catatan_observasi_restrain_nonfarma=false;catatan_observasi_ventilator=false;catatan_anestesi_sedasi=false;skrining_puma=false;satu_sehat_kirim_careplan=false;satu_sehat_kirim_medicationstatement=false;
        skrining_adiksi_nikotin=false;skrining_thalassemia=false;skrining_instrumen_sdq=false;surat_kirnikah=false;data_sasaran_usiabayi=false;data_sasaran_usiabalita=false;riwayat_perawatan_icare_fktp=false;data_sasaran_usiaprasekolah=false;
        data_sasaran_usiaremaja=false;
        try{    
            jml=0;
            for(i=0;i<tbUser.getRowCount();i++){
            ...
            ps=koneksi.prepareStatement(
                ...
                "user.skrining_adiksi_nikotin,user.skrining_thalassemia,user.skrining_instrumen_sdq,user.surat_kirnikah,user.data_sasaran_usiabayi,user.data_sasaran_usiabalita, "+
                "user.riwayat_perawatan_icare_fktp,user.data_sasaran_usiaprasekolah,user.data_sasaran_usiaremaja from user where user.id_user=AES_ENCRYPT(?,'nur')");
            try {
                ps.setString(1,user);
                rs=ps.executeQuery();
                if(rs.next()){
                    ...
                    surat_kirnikah=rs.getBoolean("surat_kirnikah");data_sasaran_usiabayi=rs.getBoolean("data_sasaran_usiabayi");data_sasaran_usiabalita=rs.getBoolean("data_sasaran_usiabalita");riwayat_perawatan_icare_fktp=rs.getBoolean("riwayat_perawatan_icare_fktp");data_sasaran_usiaprasekolah=rs.getBoolean("data_sasaran_usiaprasekolah");data_sasaran_usiaremaja=rs.getBoolean("data_sasaran_usiaremaja");
                    setTampil();
                }       
    ...
    private void setTampil(){
        ...
        if("[J]Data Sasaran Usia Bayi".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[J]Data Sasaran Usia Bayi",data_sasaran_usiabayi});
        }
        
        if("[J]Data Sasaran Usia Balita".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[J]Data Sasaran Usia Balita",data_sasaran_usiabalita});
        }
        
        if("[J]Data Sasaran Usia Prasekolah".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[J]Data Sasaran Usia Prasekolah",data_sasaran_usiaprasekolah});
        }
        
        if("[J]Data Sasaran Usia Remaja".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[J]Data Sasaran Usia Remaja",data_sasaran_usiaremaja});
        }
        ...
        if("[L]Riwayat Perawatan ICare FKTP".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Riwayat Perawatan ICare FKTP",riwayat_perawatan_icare_fktp});
        }
        ...
        if("[P]Surat KirNikah".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[P]Surat KirNikah",surat_kirnikah});
        }
    ...
    private void Simpan() {
        for(i=0;i<tbUser.getRowCount();i++){ 
            ...
            if("[J]Data Sasaran Usia Bayi".equals(tbUser.getValueAt(i,1).toString())){
                Sequel.mengedit("user","id_user=AES_ENCRYPT('"+TKd.getText()+"','nur')","data_sasaran_usiabayi='"+tbUser.getValueAt(i,2).toString()+"'");
            }
            
            if("[J]Data Sasaran Usia Balita".equals(tbUser.getValueAt(i,1).toString())){
                Sequel.mengedit("user","id_user=AES_ENCRYPT('"+TKd.getText()+"','nur')","data_sasaran_usiabalita='"+tbUser.getValueAt(i,2).toString()+"'");
            }
            
            if("[J]Data Sasaran Usia Prasekolah".equals(tbUser.getValueAt(i,1).toString())){
                Sequel.mengedit("user","id_user=AES_ENCRYPT('"+TKd.getText()+"','nur')","data_sasaran_usiaprasekolah='"+tbUser.getValueAt(i,2).toString()+"'");
            }
            
            if("[J]Data Sasaran Usia Remaja".equals(tbUser.getValueAt(i,1).toString())){
                Sequel.mengedit("user","id_user=AES_ENCRYPT('"+TKd.getText()+"','nur')","data_sasaran_usiaremaja='"+tbUser.getValueAt(i,2).toString()+"'");
            }
    ...
    private void Simpan2() {
        for(i=0;i<tbUser.getRowCount();i++){ 
            ...
            if("[L]Riwayat Perawatan ICare FKTP".equals(tbUser.getValueAt(i,1).toString())){
                Sequel.mengedit("user","id_user=AES_ENCRYPT('"+TKd.getText()+"','nur')","riwayat_perawatan_icare_fktp='"+tbUser.getValueAt(i,2).toString()+"'");
            }
