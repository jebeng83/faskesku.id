...
public class DlgUser extends javax.swing.JDialog {
    ...
    public DlgUser(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row={"ID User","Nama User","Jabatan","Password","[J]ICD 10","[J]Obat Penyakit","[C]Dokter","[A]Jadwal Praktek","[C]Petugas","[M]Pasien","[A]Registrasi","[A]Tindakan Ralan",
                ...
                "[M]Skrining Instrumen SDQ","[P]Surat KirNikah","[J]Data Sasaran Usia Bayi","[J]Data Sasaran Usia Balita","[L]Riwayat Perawatan ICare FKTP","[J]Data Sasaran Usia Prasekolah","[J]Data Sasaran Usia Remaja"
        };
        ...
        if(TKd.getText().trim().equals("")||TNmUser.getText().trim().equals("")){
            ...
            if(i!= -1){
                if(Sequel.mengedittf("user","id_user=AES_ENCRYPT('"+tbUser.getValueAt(i,0).toString()+"','nur')",
                    ...
                    "surat_kirnikah='"+tbUser.getValueAt(i,1072).toString()+"',"+ 
                    "data_sasaran_usiabayi='"+tbUser.getValueAt(i,1073).toString()+"',"+ 
                    "data_sasaran_usiabalita='"+tbUser.getValueAt(i,1074).toString()+"',"+  
                    "riwayat_perawatan_icare_fktp='"+tbUser.getValueAt(i,1075).toString()+"',"+ 
                    "data_sasaran_usiaprasekolah='"+tbUser.getValueAt(i,1076).toString()+"',"+ 
                    "data_sasaran_usiaremaja='"+tbUser.getValueAt(i,1077).toString()+"'")==true){
                    emptTeks();
                }
            }         
        }
                            ...
                            try {
                                ...
                                if(i!= -1){
                                    Sequel.mengedit("user","id_user=AES_ENCRYPT('"+tbUser.getValueAt(i,0).toString()+"','nur')",
                                        ...
                                        "surat_kirnikah='"+tbUser.getValueAt(barisdicopy,1072).toString()+"',"+
                                        "data_sasaran_usiabayi='"+tbUser.getValueAt(barisdicopy,1073).toString()+"',"+
                                        "data_sasaran_usiabalita='"+tbUser.getValueAt(barisdicopy,1074).toString()+"',"+
                                        "riwayat_perawatan_icare_fktp='"+tbUser.getValueAt(barisdicopy,1075).toString()+"',"+ 
                                        "data_sasaran_usiaprasekolah='"+tbUser.getValueAt(barisdicopy,1076).toString()+"',"+        
                                        "data_sasaran_usiaremaja='"+tbUser.getValueAt(barisdicopy,1077).toString()+"'");
    ...
    private void tampil() {        
        try{    
            ...
            ps=koneksi.prepareStatement(
                ...
                "user.riwayat_perawatan_icare_fktp,user.data_sasaran_usiaprasekolah,user.data_sasaran_usiaremaja from user order by AES_DECRYPT(user.id_user,'nur')");
            try {
                rs=ps.executeQuery();
                while(rs.next()){
                    user="";
                    ...
                    try {
                        if(rs.getString(1).toLowerCase().contains(TCari.getText().toLowerCase())||
                            ...
                            tabMode.addRow(new Object[]{rs.getString(1),
                               ...
                               rs.getBoolean("surat_kirnikah"),
                               rs.getBoolean("data_sasaran_usiabayi"),
                               rs.getBoolean("data_sasaran_usiabalita"),
                               rs.getBoolean("riwayat_perawatan_icare_fktp"),
                               rs.getBoolean("data_sasaran_usiaprasekolah"),
                               rs.getBoolean("data_sasaran_usiaremaja")
                            });
                        }   
                    } catch (Exception e) {
                        tabMode.addRow(new Object[]{rs.getString(1),
