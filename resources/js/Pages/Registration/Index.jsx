...
export default function Registration({
    ...
    return (
        <LanjutanRegistrasiLayout title="Pendaftaran Pasien" menuConfig={{ activeTab: "registrasi" }}>
            ...
            {/* Stats Cards */}
            <motion.div
                className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-1.5 lg:gap-2 mb-2"
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
            ...
            >
                {/* Total Registrasi */}
                <motion.div
                    className="bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-900/20 dark:to-blue-800/30 p-2 rounded-md border border-blue-200 dark:border-blue-700/50"
                    whileHover={{ scale: 1.02, y: -2 }}
                    transition={{ duration: 0.2 }}
                >
                    <div className="flex items-center justify-between w-full">
                        <p className="text-xs leading-tight font-medium text-blue-600 dark:text-blue-400 text-left flex items-center gap-1.5">
                            <svg className="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                            </svg>
                            Total
                        </p>
                        <p className="text-base lg:text-lg leading-tight font-bold text-blue-700 dark:text-blue-300 text-right">{stats.total}</p>
                    </div>
                </motion.div>

                {/* Status Belum */}
                <motion.div
                    className="bg-gradient-to-br from-red-50 to-red-100 dark:from-red-900/20 dark:to-red-800/30 p-2 rounded-md border border-red-200 dark:border-red-700/50"
                    whileHover={{ scale: 1.02, y: -2 }}
                    transition={{ duration: 0.2 }}
                >
                    <div className="flex items-center justify-between w-full">
                        <p className="text-xs leading-tight font-medium text-red-600 dark:text-red-400 text-left flex items-center gap-1.5">
                            <svg className="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                            </svg>
                            Belum
                        </p>
                        <p className="text-base lg:text-lg leading-tight font-bold text-red-700 dark:text-red-300 text-right">{stats.belum}</p>
                    </div>
                </motion.div>

                {/* Status Selesai */}
                <motion.div
                    className="bg-gradient-to-br from-green-50 to-green-100 dark:from-green-900/20 dark:to-green-800/30 p-2 rounded-md border border-green-200 dark:border-green-700/50"
                    whileHover={{ scale: 1.02, y: -2 }}
                    transition={{ duration: 0.2 }}
                >
                    <div className="flex items-center justify-between w-full">
                        <p className="text-xs leading-tight font-medium text-green-600 dark:text-green-400 text-left flex items-center gap-1.5">
                            <svg className="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                            </svg>
                            Selesai
                        </p>
                        <p className="text-base lg:text-lg leading-tight font-bold text-green-700 dark:text-green-300 text-right">{stats.selesai}</p>
                    </div>
                </motion.div>

                {/* Status Batal */}
                <motion.div
                    className="bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900/20 dark:to-gray-800/30 p-2 rounded-md border border-gray-200 dark:border-gray-700/50"
                    whileHover={{ scale: 1.02, y: -2 }}
                    transition={{ duration: 0.2 }}
                >
                    <div className="flex items-center justify-between w-full">
                        <p className="text-xs leading-tight font-medium text-gray-600 dark:text-gray-400 text-left flex items-center gap-1.5">
                            <svg className="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M6 18L18 6M6 6l12 12" />
                            </svg>
                            Batal
                        </p>
                        <p className="text-base lg:text-lg leading-tight font-bold text-gray-700 dark:text-gray-300 text-right">{stats.batal}</p>
                    </div>
                </motion.div>

                {/* Pasien Baru */}
                <motion.div
                    className="bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-900/20 dark:to-purple-800/30 p-2 rounded-md border border-purple-200 dark:border-purple-700/50"
                    whileHover={{ scale: 1.02, y: -2 }}
                    transition={{ duration: 0.2 }}
                >
                    <div className="flex items-center justify-between w-full">
                        <p className="text-xs leading-tight font-medium text-purple-600 dark:text-purple-400 text-left flex items-center gap-1.5">
                            <svg className="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6v12M6 12h12" />
                            </svg>
                            Baru
                        </p>
                        <p className="text-base lg:text-lg leading-tight font-bold text-purple-700 dark:text-purple-300 text-right">{stats.baru}</p>
                    </div>
                </motion.div>

                {/* Pasien Lama */}
                <motion.div
                    className="bg-gradient-to-br from-orange-50 to-orange-100 dark:from-orange-900/20 dark:to-orange-800/30 p-2 rounded-md border border-orange-200 dark:border-orange-700/50"
                    whileHover={{ scale: 1.02, y: -2 }}
                    transition={{ duration: 0.2 }}
                >
                    <div className="flex items-center justify-between w-full">
                        <p className="text-xs leading-tight font-medium text-orange-600 dark:text-orange-400 text-left flex items-center gap-1.5">
                            <svg className="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                            </svg>
                            Lama
                        </p>
                        <p className="text-base lg:text-lg leading-tight font-bold text-orange-700 dark:text-orange-300 text-right">{stats.lama}</p>
                    </div>
                </motion.div>

                {/* Total Biaya dihapus sesuai permintaan */}
            </motion.div>
