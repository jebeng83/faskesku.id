                                                        ...
                                                        >
                                                            <div className="flex justify-between items-start">
                                                                ...
                                                                <div className="text-right flex-shrink-0">
                                                                    <motion.button
                                                                        type="button"
                                                                        title="Panggil Antrean (Hadir) lalu buka Rawat Jalan Index"
                                                                        onClick={(
                                                                            e
                                                                        ) => {
                                                                            e.stopPropagation();
                                                                        ...
                                                                        className="text-xs lg:text-sm font-medium text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 mb-2 hover:underline"
                                                                        initial={{
                                                                            opacity: 0,
                                                                        }}
                                                                        animate={{
                                        ...
                                        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
                                            ...
                                            <div className="flex items-center space-x-2">
                                                ...
                                                <motion.button
                                                    ...
                                                    whileHover={{
                                                        scale: registrationData.prev_page_url
                                                            ? 1.05
                                                            : 1,
                                                    }}
                                                    whileTap={{
                                                ...
                                                <motion.button
                                                    ...
                                                    className="px-3 py-2 text-sm font-medium text-gray-500 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed dark:bg-gray-800 dark:border-gray-600 dark:text-gray-400 dark:hover:bg-gray-700"
                                                    whileHover={{
                                                        scale: registrationData.next_page_url
                                                            ? 1.05
                                                            : 1,
                                                    }}
                                                    whileTap={{
