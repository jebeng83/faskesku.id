...
export default function Bank({ auth, bank, flash, filters }) {
    ...
    const handleDelete = (id) => {
        if (confirm('Apakah Anda yakin ingin menghapus data bank ini?')) {
            router.delete(route('bank.destroy', id));
        }
    };
    ...
    return (
        <AppLayout
            user={auth.user}
            header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">Data Bank</h2>}
        >
                    ...
                    <div className="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        <div className="p-6 text-gray-900">
                            ...
                            <div className="flex justify-between items-center mb-6">
                                <h3 className="text-lg font-medium">Daftar Bank</h3>
                                <button
                                    onClick={openModal}
                                    ...
                                    <div className="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
                                        <div>
                                            <p className="text-sm text-gray-700">
                                                Showing <span className="font-medium">{bank.from}</span> to{' '}
                                                <span className="font-medium">{bank.to}</span> of{' '}
                                                <span className="font-medium">{bank.total}</span> results
                                            </p>
                                        </div>
                                        <div>
                                            <nav className="relative z-0 inline-flex rounded-md shadow-sm -space-x-px">
                                                {bank.links.map((link, index) => (
                                                    <button
                                                        key={index}
                                                        ...
                                                        className={`relative inline-flex items-center px-2 py-2 border text-sm font-medium ${
                                                            ...
                                                            index === bank.links.length - 1 ? 'rounded-r-md' : ''
                                                        }`}
                                                ...
                                                <div className="mb-4">
                                                    ...
                                                    <input
                                                        ...
                                                        className={`block w-full px-3 py-2 border rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm ${
                                                            errors.namabank ? 'border-red-300' : 'border-gray-300'
                                                        }`}
                                                        placeholder="Masukkan nama bank"
                                                        maxLength="50"
                                                    />
                                                    {errors.namabank && (
                                                        <p className="mt-1 text-sm text-red-600">{errors.namabank}</p>
                                                    )}
