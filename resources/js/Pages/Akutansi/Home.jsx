...
const tabs = [
    ...
    },
    {
            ...
            items: [
                ...
                {
                    title: "Closing Kasir",
                    description: "Konfigurasi waktu shift kasir",
                    href: "/akutansi/closing-kasir",
                    icon: Calendar,
                    accent: "from-blue-500 to-indigo-500",
                },
                {
                    title: "Rekap Uang per Shift",
                    description: "Rekap transaksi per shift",
                    href: "/akutansi/rekap-uang-pershift",
                    icon: Receipt,
                    accent: "from-indigo-500 to-purple-500",
                },
                {
                ...
                },
                {
                    ...
                    description: "Pencatatan pemasukan non-standar",
                    href: "/akutansi/pemasukan-lain",
                    icon: Wallet,
                    accent: "from-indigo-500 to-purple-500",
                },
                {
                    title: "Pengeluaran Harian",
                    description: "Pencatatan pengeluaran harian",
                    href: "/akutansi/pengeluaran-harian",
                    icon: Wallet,
