...
export default function PenjualanObat() {
    ...
    const filteredData = salesData.filter(item => {
        const matchesSearch = item.no_nota.toLowerCase().includes(search.toLowerCase()) ||
                        ...
                        <div className="flex justify-between items-center">
                            <div>
                                ...
                                <p className="text-gray-600 dark:text-gray-400 mt-1">
                                    Kelola penjualan obat dan transaksi farmasi
                                </p>
                            </div>
                    ...
                    <div className="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                        <div className="p-6">
                            <div className="flex items-center">
                                ...
                                <div className="ml-4">
                                    <p className="text-sm font-medium text-gray-500 dark:text-gray-400">Lunas</p>
                        ...
                        <div className="flex flex-col md:flex-row gap-4">
                            <div className="flex-1">
                                <input
                                    ...
                                    placeholder="Cari berdasarkan no nota, pasien, atau kasir..."
