...
const tabs = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        description: "Relasi konversi antar satuan (mis. box → strip → tablet)",
      ...
      {
        title: "Data Obat",
        description: "Kelola daftar obat, satuan, dan detail spesifikasi",
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        description: "Transaksi penjualan untuk pasien umum dan penjamin",
      ...
      {
        title: "Resep Obat",
        description: "Proses resep dari layanan Rawat Jalan/IGD/Rawat Inap",
      ...
      },
      {
        ...
        description: "Mutasi stok antar gudang & depo farmasi",
    ...
    items: [
      {
        ...
        href: route("farmasi.dashboard"),
        icon: ChartBarIcon,
        accent: "from-indigo-500 to-blue-500",
      },
      {
        title: "Laporan Penjualan",
        description: "Ringkasan transaksi penjualan berdasarkan periode",
        href: route("farmasi.penjualan-obat"),
        icon: BanknotesIcon,
        ...
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400">
              Kelola data, proses transaksi, dan pantau laporan farmasi.
            </p>
          </div>
        </div>
