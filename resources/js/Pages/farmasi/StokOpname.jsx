...
export default function StokOpname() {
    ...
    const submitObatBaru = async () => {
        ...
        if (!obatForm.kode_brng || !obatForm.nama_brng || !obatForm.dasar) {
            toast(
                "Kode barang, nama barang, dan harga dasar wajib diisi",
                "error"
            );
            return;
        }
        try {
            ...
            const payload = {
                ...
                kapasitas: obatForm.kapasitas
                    ? parseInt(obatForm.kapasitas)
                    : 0,
                status: obatForm.status || "1",
                letak_barang: obatForm.letak_barang || "Apotek",
                stokminimal:
                    obatForm.stokminimal !== ""
                        ? parseInt(obatForm.stokminimal)
                        : undefined,
    ...
    const addItemToOpname = (barang) => {
        const existingItemIndex = opnameItems.findIndex(
            (item) =>
                item.kode_brng === barang.kode_brng &&
                (item.no_batch ?? null) === (barang.no_batch ?? null) &&
                (item.no_faktur ?? null) === (barang.no_faktur ?? null)
        );
        ...
        const newItem = {
            ...
            no_batch: barang.no_batch ?? null,
            no_faktur: barang.no_faktur ?? null,
        };
    ...
    const handleRealChange = (index, value) => {
        ...
        newItems[index].lebih =
            newItems[index].selisih > 0 ? newItems[index].selisih : 0;
        newItems[index].nomihilang =
            newItems[index].selisih < 0
                ? Math.abs(newItems[index].selisih) * harga
                : 0;
        newItems[index].nomilebih =
            newItems[index].selisih > 0 ? newItems[index].selisih * harga : 0;
    ...
    const handleSubmit = async (e) => {
        ...
        for (let i = 0; i < opnameItems.length; i++) {
            ...
            if (val < 0) {
                toast(
                    `${opnameItems[i].kode_brng} ${opnameItems[i].nama_brng} memiliki nilai real < 0`,
                    "error"
                );
                return;
            }
        ...
        try {
            ...
            if (response?.data?.success) {
                ...
                const msg =
                    ...
                    "Gagal menyimpan data stok opname";
                setAlertConfig({
                    type: "error",
                    title: "Gagal",
                    message: msg,
    ...
    const getTotalNominalHilang = () => {
        return opnameItems.reduce(
            (total, item) => total + (item.nomihilang || 0),
            0
        );
    };
    ...
    const getTotalNominalLebih = () => {
        return opnameItems.reduce(
            (total, item) => total + (item.nomilebih || 0),
            0
        );
    };
        ...
        <SidebarFarmasi title="Farmasi">
            ...
            <div className="py-6">
                <div className="max-w-full mx-auto px-0">
                    ...
                    >
                        <CardHeader className="relative px-4 py-2.5 border-b border-gray-200/50 dark:border-gray-700/50 bg-gradient-to-r from-blue-50/80 via-indigo-50/80 to-purple-50/80 dark:from-gray-700/80 dark:via-gray-700/80 dark:to-gray-700/80 backdrop-blur-sm">
                            <CardTitle>
                        ...
                        <CardContent>
                            <div className="space-y-4">
                                ...
                                <div className="flex gap-2">
                                    ...
                                    <Button
                                        onClick={() =>
                                            router.visit("/farmasi/data-opname")
                                        }
                                        variant="outline"
                                        className="transition-transform duration-300 ease-out hover:scale-[1.02]"
                                    >
                    ...
                    {opnameItems.length > 0 && (
                        ...
                        >
                            <CardHeader className="relative px-4 py-2.5 border-b border-gray-200/50 dark:border-gray-700/50 bg-gradient-to-r from-blue-50/80 via-indigo-50/80 to-purple-50/80 dark:from-gray-700/80 dark:via-gray-700/80 dark:to-gray-700/80 backdrop-blur-sm flex items-center justify-between">
                                <CardTitle>
                                    <span className="bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">
                            ...
                            <CardContent>
                                    ...
                                    <Table>
                                        <TableHeader>
                                            <TableRow>
                                                ...
                                                <TableHead className="text-base text-center min-w-[200px]">
                                                    Real
                                                </TableHead>
                                ...
                                <div className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4 p-4 bg-gray-50 rounded-lg">
                                    <div className="text-red-600">
                                        <strong>
                                            Total Nominal Hilang:{" "}
                                            {formatRupiah(
                                                getTotalNominalHilang()
                                            )}
                                        </strong>
                                    </div>
            ...
            <AnimatePresence>
                {showSearchModal && (
                    ...
                    >
                        <motion.div
                            className="w-full max-w-5xl max-h-[80vh] overflow-hidden rounded-2xl bg-white/90 dark:bg-gray-800/90 backdrop-blur-xl border border-white/20 dark:border-gray-700/50 shadow-xl shadow-blue-500/5 p-6"
                            initial={{ y: 24, opacity: 0 }}
                            animate={{ y: 0, opacity: 1 }}
                            exit={{ y: 24, opacity: 0 }}
                            transition={{ duration: 0.3 }}
                        >
                            <div className="relative px-4 py-2.5 border-b border-gray-200/50 dark:border-gray-700/50 bg-gradient-to-r from-blue-50/80 via-indigo-50/80 to-purple-50/80 dark:from-gray-700/80 dark:via-gray-700/80 dark:to-gray-700/80 backdrop-blur-sm flex items-center justify-between rounded-lg">
                            ...
                            <div className="mt-4">
                                <Input
                                    ...
                                    className="w-full border-gray-300 dark:border-gray-600 focus:ring-2 focus:ring-blue-500/50 transition-shadow duration-300 ease-out hover:shadow-sm"
                                />
                            </div>
            ...
            <ConfirmationAlert
                ...
                type="info"
                title="Konfirmasi Simpan Opname"
                message="Apakah Anda yakin ingin menyimpan stok opname? Pastikan data sudah benar."
                confirmText="Simpan"
                cancelText="Batal"
                ...
                {showAddObatModal && (
                    ...
                    >
                        <motion.div
                            ...
                            className="mx-4 w-full max-w-xl rounded-xl bg-white p-6 shadow-xl"
                        >
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-2">
                                ...
                                <div>
                                    <Label htmlFor="kode_satbesar_modal">
                                        Kode Satuan Besar
                                    </Label>
                                    <Input
                                        id="kode_satbesar_modal"
                                ...
                                <div>
                                    <Label htmlFor="letak_barang_modal">
                                        Letak Barang
                                    </Label>
                                    <Input
                                        id="letak_barang_modal"
                                ...
                                <div>
                                    <Label htmlFor="stokminimal_modal">
                                        Stok Minimal
                                    </Label>
                                    <Input
                                        id="stokminimal_modal"
                                        type="number"
                                ...
                                <div>
                                    ...
                                    <Input
                                        ...
                                        placeholder="Mis. J001"
                                    />
                                </div>
                                <div>
                                    <Label htmlFor="expire_modal">
                                        Tanggal Expire
                                    </Label>
                                    <Input
                                        id="expire_modal"
                                ...
                                <div>
                                    <Label htmlFor="kode_industri_modal">
                                        Kode Industri
                                    </Label>
                                    <Input
                                        id="kode_industri_modal"
                                        ...
                                        placeholder="Mis. I0001"
                                    />
                                </div>
                                <div>
                                    <Label htmlFor="kode_kategori_modal">
                                        Kode Kategori
                                    </Label>
                                    <Input
                                        id="kode_kategori_modal"
                                        ...
                                        placeholder="Mis. K001"
                                    />
                                </div>
                                <div>
                                    <Label htmlFor="kode_golongan_modal">
                                        Kode Golongan
                                    </Label>
                                    <Input
                                        id="kode_golongan_modal"
