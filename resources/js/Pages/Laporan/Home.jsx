        ...
        <SidebarLaporan title="Laporan">
            ...
            <div className="px-2 sm:px-4 lg:px-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
                    ...
                    <div className={`bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 shadow-sm p-5 hover:shadow-md transition-all duration-200 group ${isLoadingRanap ? 'opacity-70' : ''}`}>
