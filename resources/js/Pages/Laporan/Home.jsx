        ...
        <SidebarLaporan title="Laporan">
            ...
            <div className="px-2 sm:px-4 lg:px-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
                    <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 shadow-sm p-5 hover:shadow-md transition-all duration-200 group">
                        <div className="flex items-start justify-between mb-4">
                            ...
                            <DropdownMenu
                                ...
                                align="end"
                            >
                                <DropdownItem onClick={() => handleFilterChange("ranap", "today")}>
                                    Hari Ini
                                </DropdownItem>
                                <DropdownItem onClick={() => handleFilterChange("ranap", "week")}>
                                    Minggu Ini
                                </DropdownItem>
                                <DropdownItem onClick={() => handleFilterChange("ranap", "month")}>
                                    Bulan Ini
                                </DropdownItem>
                                <DropdownItem onClick={() => handleFilterChange("ranap", "year")}>
                                    Tahun Ini
                                </DropdownItem>
                            </DropdownMenu>
                        </div>
                        ...
                        <div className="mb-4">
                            <div className="flex justify-between text-xs mb-1.5">
                                ...
                                <span className="font-bold text-blue-600 dark:text-blue-400">
                                    {formatPercent(ranap?.okupansi_pct)}
                                </span>
                            </div>
                            <div className="w-full bg-gray-100 dark:bg-gray-800 rounded-full h-1.5 overflow-hidden">
                                <div
                                    ...
                                    style={{
                                        width: `${Math.min(ranap?.okupansi_pct || 0, 100)}%`,
                                    }}
                                />
                            </div>
                    ...
                    <div
                        className={`bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 shadow-sm p-5 hover:shadow-md transition-all duration-200 group ${
                            isLoadingRalan ? "opacity-70" : ""
                        }`}
                    >
                        <div className="flex items-start justify-between mb-4">
                            <div className="flex gap-3">
                            ...
                            <DropdownMenu
                                ...
                                align="end"
                            >
                                <DropdownItem onClick={() => handleFilterChange("ralan", "today")}>
                                    Hari Ini
                                </DropdownItem>
                                <DropdownItem onClick={() => handleFilterChange("ralan", "week")}>
                                    Minggu Ini
                                </DropdownItem>
                                <DropdownItem onClick={() => handleFilterChange("ralan", "month")}>
                                    Bulan Ini
                                </DropdownItem>
                                <DropdownItem onClick={() => handleFilterChange("ralan", "year")}>
                                    Tahun Ini
                                </DropdownItem>
                            </DropdownMenu>
                        </div>
                        ...
                        <div className="mb-4">
                            <div className="flex justify-between text-xs mb-1.5">
                                ...
                                <span className="font-bold text-emerald-600 dark:text-emerald-400">
                                    {formatPercent(
                                        ((ralan?.baru || 0) / (ralan?.total || 1)) * 100
                                    )}
                                </span>
                            </div>
                            <div className="w-full bg-gray-100 dark:bg-gray-800 rounded-full h-1.5 overflow-hidden">
                    ...
                    >
                        <div className="flex items-start justify-between mb-6">
                            ...
                            <DropdownMenu
                                ...
                                align="end"
                            >
                                <DropdownItem onClick={() => handleFilterChange("igd", "today")}>
                                    Hari Ini
                                </DropdownItem>
                                <DropdownItem onClick={() => handleFilterChange("igd", "week")}>
                                    Minggu Ini
                                </DropdownItem>
                                <DropdownItem onClick={() => handleFilterChange("igd", "month")}>
                                    Bulan Ini
                                </DropdownItem>
                                <DropdownItem onClick={() => handleFilterChange("igd", "year")}>
                                    Tahun Ini
                                </DropdownItem>
                            </DropdownMenu>
                        </div>
                        ...
                        <div className="mb-4">
                            <div className="flex justify-between text-xs mb-1.5">
                                ...
                                <span className="font-bold text-rose-600 dark:text-rose-400">
                                    {formatPercent(
                                        ((igd?.lanjut_ranap || 0) / (igd?.total || 1)) * 100
                                    )}
                                </span>
                            </div>
                            <div className="w-full bg-gray-100 dark:bg-gray-800 rounded-full h-1.5 overflow-hidden">
                        ...
                        <div className="flex items-center justify-between pt-4 border-t border-gray-100 dark:border-gray-800">
                            ...
                            <Link
                                href="/laporan/igd/kunjungan"
                                className="text-xs font-bold text-rose-600 hover:text-rose-700 dark:text-rose-400 dark:hover:text-rose-300 flex items-center gap-1"
                            >
                                Lihat Detail →
                            </Link>
                        </div>
                    ...
                    <div className="lg:col-span-2 bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 shadow-sm p-6">
                        <div className="flex items-center justify-between mb-6">
                            ...
                            <DropdownMenu
                                ...
                                align="end"
                            >
                                <DropdownItem onClick={() => handleChartFilterChange("week")}>
                                    Minggu Ini
                                </DropdownItem>
                                <DropdownItem onClick={() => handleChartFilterChange("month")}>
                                    Bulan Ini
                                </DropdownItem>
                                <DropdownItem onClick={() => handleChartFilterChange("year")}>
                                    Tahun Ini
                                </DropdownItem>
                            </DropdownMenu>
                        </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
                    <div className="lg:col-span-2 bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 shadow-sm p-6">
                        <div className="mb-6">
                            ...
                            <p className="text-sm text-gray-500 dark:text-gray-400">
                                Top 10 poliklinik hari ini
                            </p>
                        </div>
                        <div className="h-[300px] w-full">
                            <ResponsiveContainer width="100%" height="100%">
                                <BarChart
                                    data={summary?.poli_stats || []}
                                    layout="vertical"
                    ...
                    <div className="bg-gradient-to-br from-indigo-500 to-purple-600 rounded-2xl shadow-sm p-6 text-white flex flex-col justify-between">
                        ...
                        <div>
                            <div className="text-4xl font-bold mb-1">
                                {formatNumber(
                                    (summary?.rawat_jalan?.total || 0) +
                                        (summary?.rawat_inap?.total || 0) +
                                        (summary?.igd?.total || 0)
                                )}
                            </div>
                ...
                <div
                    ref={chartRef}
                    className="mb-8 rounded-2xl bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 shadow-sm p-6"
                >
                    <div className="flex items-center justify-between mb-6">
                        <div>
                            <h3 className="text-lg font-semibold text-gray-900 dark:text-white">
