...
export default function SurveilansPenyakitRalan() {
    ...
    const fetchData = async () => {
        setLoading(true);
        try {
            const response = await axios.get(route('laporan.ralan.surveilans-penyakit.data'), {
                params: {
    ...
    return (
        <SidebarLaporan title="Laporan">
            <Head title="surveilans Penyakit Ralan" />

            <div className="px-4 sm:px-6 lg:px-8 py-6 print:p-0">
                <div className="sm:flex sm:items-center print:hidden">
                    <div className="sm:flex-auto">
                        <h1 className="text-2xl font-semibold text-gray-900 dark:text-white">surveilans Penyakit Ralan</h1>
                        <p className="mt-2 text-sm text-gray-700 dark:text-gray-300">
                            Laporan surveilans penyakit rawat jalan (Kasus Baru).
                        </p>
                    </div>
                </div>
