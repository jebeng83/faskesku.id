...
export default function ReferensiProvider() {
  ...
  return (
    <div className="w-full">
      ...
      <div className="mb-4">
        <div className="flex items-center justify-between">
          <div>
            ...
            <h1 className="text-xl font-semibold text-slate-800 tracking-tight">Referensi Provider Rayonisasi</h1>
          </div>
      ...
      {/* Status */}
      {loading && (
        <div className="mb-3 text-xs text-slate-500">Memuat data provider...</div>
      )}
      {error && (
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
        {data.map((item) => (
          <div
            key={`${item.kdProvider}-${item.nmProvider}`}
...
ReferensiProvider.layout = (page) => <AppLayout title="Referensi Provider PCare" children={page} />;