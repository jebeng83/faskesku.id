...
export default function Lanjutan({ rawatJalan, params }) {
    ...
    const renderActiveTabContent = () => {
        ...
        switch (activeTab) {
            ...
            case 'resep':
                return <Resep {...commonProps} kdPoli={rawatJalan?.kd_poli || params?.kd_poli || ''} />;
            case 'diagnosa':
        ...
        <div className="bg-red-50 dark:bg-red-900/20 rounded-lg p-4 border border-red-200 dark:border-red-800">
            <div className="flex flex-col sm:flex-row sm:items-center gap-3">
                ...
                <div className="flex-1 min-w-0">
                    ...
                    <p className="text-xs text-red-600 dark:text-red-400 mt-1 break-words">{message}</p>
                </div>
                {onRetry && (
                    <button
                        onClick={onRetry}
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                                <div className="bg-blue-50 dark:bg-blue-900/20 rounded-xl p-4 border border-blue-200 dark:border-blue-800">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div className="flex-1 min-w-0">
                                            <p className="text-xs font-medium text-blue-600 dark:text-blue-400 uppercase tracking-wide">Nama Pasien</p>
                                            <p className="text-sm font-semibold text-gray-900 dark:text-white mt-1 truncate">{rawatJalan.patient.nm_pasien || '-'}</p>
                                        </div>
                                    </div>
                                </div>
                                <div className="bg-green-50 dark:bg-green-900/20 rounded-xl p-4 border border-green-200 dark:border-green-800">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div className="flex-1 min-w-0">
                                            <p className="text-xs font-medium text-green-600 dark:text-green-400 uppercase tracking-wide">No. Rekam Medis</p>
                                            <p className="text-sm font-semibold text-gray-900 dark:text-white mt-1 truncate font-mono">{rawatJalan.patient.no_rkm_medis || '-'}</p>
                                        </div>
                                    </div>
                                </div>
                                <div className="bg-purple-50 dark:bg-purple-900/20 rounded-xl p-4 border border-purple-200 dark:border-purple-800">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div className="flex-1 min-w-0">
                                            <p className="text-xs font-medium text-purple-600 dark:text-purple-400 uppercase tracking-wide">No. Rawat</p>
                                            <p className="text-sm font-semibold text-gray-900 dark:text-white mt-1 truncate font-mono">{rawatJalan.no_rawat || '-'}</p>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div className="flex items-center gap-3">
                                        <div className="p-2 bg-orange-100 dark:bg-orange-800/30 rounded-lg">
                                            <svg className="w-5 h-5 text-orange-600 dark:text-orange-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3a4 4 0 118 0v4m-4 4v6m0 0l-3-3m3 3l3-3" />
                                            </svg>
                                        </div>
                                        <div className="flex-1 min-w-0">
                                            <p className="text-xs font-medium text-orange-600 dark:text-orange-400 uppercase tracking-wide">Tanggal Registrasi</p>
                            ...
                            <div className="bg-yellow-50 dark:bg-yellow-900/20 rounded-xl p-6 border border-yellow-200 dark:border-yellow-800">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div className="flex-1">
                                        <h4 className="text-lg font-semibold text-yellow-800 dark:text-yellow-200">Data Pasien Tidak Ditemukan</h4>
                                        <p className="text-sm text-yellow-600 dark:text-yellow-400 mt-1">No. Rawat: {params?.no_rawat || '-'} | No. RM: {params?.no_rkm_medis || '-'}</p>
                                    </div>
                                    <button
                    ...
                    <div className="bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-700 px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                        <h3 className="text-lg font-semibold text-gray-900 dark:text-white flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-500 dark:text-gray-400 font-normal mt-1">Pilih menu untuk mengelola data pemeriksaan</p>
                            </div>
                        </h3>
                    </div>
                                ...
                                return (
                                    <button
                                        ...
                                        className={`
                                            ...
                                            ${isActive ? 'border-current shadow-sm' : 'border-transparent'}
                                        `}
                                    >
                                        {tab.icon}
                                        <span>{tab.title}</span>
                                ...
                                >
                                    ...
                                    <svg
                                        className={`w-5 h-5 text-gray-500 transition-transform duration-200 ${
                                            openAcc.pemeriksaan ? 'rotate-180' : ''
                                        }`}
                                        fill="none"
                                        stroke="currentColor"
                                        viewBox="0 0 24 24"
                                    ...
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            <h3 className="text-lg font-semibold text-gray-900 dark:text-white">
                                                {menuTabs.find(tab => tab.key === activeTab)?.title}
                                            </h3>
                                            <p className="text-sm text-gray-500 dark:text-gray-400 font-normal">
                                                {menuTabs.find(tab => tab.key === activeTab)?.subtitle}
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                {isLoading ? (
                                    <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-800 shadow-sm p-12">
                                        <div className="flex items-center justify-center">
                                            ...
                                            <span className="ml-3 text-sm text-gray-600 dark:text-gray-400">Memuat...</span>
                                        </div>
                                    </div>
                                ) : error ? (
