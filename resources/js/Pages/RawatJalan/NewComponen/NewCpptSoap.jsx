...
const ensureJsBarcode = async () => {
  ...
  return new Promise((resolve) => {
    ...
    s.src = 'https://cdn.jsdelivr.net/npm/jsbarcode@3.12.3/dist/JsBarcode.all.min.js';
    s.async = true;
    s.onload = () => resolve(window.JsBarcode || null);
                ...
                try {
                  ...
                  try {
                    if (noKunjungan) {
                      ...
                      if (JsBarcodeLib) {
                        JsBarcodeLib(svgEl, String(noKunjungan), { format: 'CODE128', width: 2, height: 50, margin: 0, displayValue: false });
