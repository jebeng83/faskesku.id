            ...
            <form onSubmit={handleSubmit} className="space-y-6 bg-[oklch(98.5%_0_0)]">
                ...
                <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg overflow-hidden">
                            ...
                            <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
                                {rows.map((row, idx) => (
                                    <tr key={idx} className="bg-white dark:bg-gray-800">
                                        ...
                                        <td className="px-3 py-2">
                                            <button type="button" onClick={() => removeRow(idx)} className="px-2 py-1 text-xs rounded bg-red-600 text-white disabled:opacity-50" disabled={rows.length <= 1 && idx === 0}>Hapus</button>
                                        </td>
                                    </tr>
                                ))}
                            </tbody>
                    ...
                    <div className="px-3 py-2 border-t border-gray-200 dark:border-gray-700">
                        <button type="button" onClick={addRow} className="px-3 py-1.5 text-xs rounded bg-indigo-600 text-white">Tambah Baris</button>
                    </div>
                </div>
