...
export default function SuratSakit({ rawatJalan, patient, dokter, setting, suratSakitData, embedded = false, templateSelector, validationUrl }) {
    ...
    const [hasSaved, setHasSaved] = useState(!!suratSakitData);
                                ...
                                <div className="p-4 sm:p-6 print:p-0">
                                    <div className="mx-auto w-full bg-white text-gray-900 rounded-xl border border-gray-200 shadow-sm print:shadow-none print:border-0 print:rounded-none print-container print:p-3">
                                        ...
                                        <div className="px-5 pt-2 pb-3 print:px-3 print:pt-0 print:pb-0">
                                            ...
                                            <div className="mt-2 grid grid-cols-2 gap-3 text-xs leading-tight print:mt-1.5 print:gap-2 print:text-[10px]">
                                                <div className="rounded-lg border border-gray-300 px-2.5 py-1.5 print:border-gray-800 print:px-2 print:py-1">
                                                    ...
                                                    <div className="grid grid-cols-[70px_3px_1fr] gap-x-1 gap-y-0.5">
                                                        ...
                                                        <div className="text-gray-700 print-text-black">:</div>
                                                        <div className="print-text-black">{patient?.jk === 'L' ? 'Laki-laki' : 'Perempuan'}</div>
                                                        <div className="text-gray-700 print-text-black">Alamat</div>
                                                        <div className="text-gray-700 print-text-black">:</div>
                                                        <div className="print-text-black uppercase whitespace-normal break-words">{patientFullAddress() || safeText(patient?.alamat)}</div>
                                                    </div>
                                                    {formData.is_pihak_kedua && (
                                                        <div className="mt-2 pt-1 border-t border-dashed border-gray-300 print:border-gray-800">
                                                            <div className="text-[10px] font-bold tracking-wide mb-0.5 print-text-bold uppercase print:mb-1">IDENTITAS KELUARGA / WALI</div>
                                                            <div className="grid grid-cols-[70px_3px_1fr] gap-x-1 gap-y-0.5">
                                                                <div className="text-gray-700 print-text-black">Nama</div>
                                                                <div className="text-gray-700 print-text-black">:</div>
                                                                <div className="font-semibold print-text-bold truncate">{safeText(formData.nama2)}</div>
                                                                <div className="text-gray-700 print-text-black">Tgl Lahir</div>
                                                                <div className="text-gray-700 print-text-black">:</div>
                                                                <div className="print-text-black">{formatShortDate(formData.tgl_lahir)}</div>
                                                                <div className="text-gray-700 print-text-black">JK</div>
                                                                <div className="text-gray-700 print-text-black">:</div>
                                                                <div className="print-text-black">{formData.jk === 'L' ? 'Laki-laki' : 'Perempuan'}</div>
                                                                <div className="text-gray-700 print-text-black">Umur</div>
                                                                <div className="text-gray-700 print-text-black">:</div>
                                                                <div className="print-text-black">{safeText(formData.umur)}</div>
                                                                <div className="text-gray-700 print-text-black">Hubungan</div>
                                                                <div className="text-gray-700 print-text-black">:</div>
                                                                <div className="print-text-black">{safeText(formData.hubungan)}</div>
                                                                <div className="text-gray-700 print-text-black">Alamat</div>
                                                                <div className="text-gray-700 print-text-black">:</div>
                                                                <div className="print-text-black uppercase whitespace-normal break-words">{safeText(formData.alamat)}</div>
                                                            </div>
                                                        </div>
                                                    )}
                                                </div>
                                            ...
                                            <div className="mt-3 grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 items-start print:mt-0 print:flex print:flex-row print:gap-6 print:items-stretch">
                                                {/* Validation Side */}
