                        ...
                        <form onSubmit={handleSearch} className="flex flex-col lg:flex-row lg:items-end gap-4 lg:justify-end">
                            ...
                            <div className="flex flex-col sm:flex-row sm:flex-wrap gap-2 sm:justify-end">
                                <select
                                    ...
                                    className="w-full sm:w-auto px-2 sm:px-3 py-2 text-xs sm:text-sm border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
                                >
