...
export default function UGD() {
  ...
  const isSelectedBpjs = useMemo(() => {
    const penjabName = String(penjabMap[form.kd_pj] || "").toUpperCase();
    return penjabName.includes("BPJS") || penjabName.includes("BPJ");
  }, [form.kd_pj, penjabMap]);
