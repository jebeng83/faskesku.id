    ...
    <AppLayout title="SATUSEHAT">
      <div className="px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div className="mb-4 flex items-center justify-between">
          <div>
            <h1 className="text-xl font-semibold text-slate-800 tracking-tight">Menu SatuSehat</h1>
            <p className="text-xs text-slate-500">Akses cepat ke fitur SATUSEHAT</p>
          </div>
        ...
        {/* Footer Note */}
        <div className="mt-4 text-[10px] text-slate-400">Tip: Klik kartu untuk membuka halaman pengelolaan.</div>
      </div>
    </AppLayout>
  );
}