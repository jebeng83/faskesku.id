...
export default function SidebarLaporan({ title = "Laporan", children }) {
    ...
    // remove unused resolveHref after switching to relative URLs and route builders
    const items = [
            {
                label: "Dashboard",
                href: "/dashboard",
            ...
            },
            {
                    ...
                    children: [
                        {
                            ...
                            href: ralan.frekuensiPenyakit.url(),
                            icon: <Activity className="w-4 h-4" />,
                        },
                        {
                            label: "Kunjungan",
                            href: ralan.kunjungan.url(),
                ...
                },
                {
                    ...
                    children: [
                        {
                            label: "Frekuensi Penyakit",
                            href: ranap.frekuensiPenyakit.url(),
                            icon: <Activity className="w-4 h-4" />,
                        },
                        {
                            label: "Kunjungan",
                            href: ranap.kunjungan.url(),
                            icon: <Users className="w-4 h-4" />,
                        },
                    ],
                },
