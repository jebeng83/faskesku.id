...
import fastMoving53c06f from './fast-moving'
import resep_dokter from './resep_dokter'
import hutangObat2cda7d from './hutang-obat'
import penjualan from './penjualan'
import setLokasi5fb3bc from './set-lokasi'
...
/**
* @see routes/web.php:2750
* @see routes/web.php:2732
* @route '/farmasi/obat-fast-moving'
*/
export const fastMoving = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: fastMoving.url(options),
    method: 'get',
})

fastMoving.definition = {
    methods: ["get","head"],
    url: '/farmasi/obat-fast-moving',
...
fastMoving.url = (options?: RouteQueryOptions) => {
    return fastMoving.definition.url + queryParams(options)
}
...
/**
* @see routes/web.php:2645
* @see routes/web.php:2627
* @route '/farmasi'
*/
...
/**
* @see routes/web.php:2650
* @see routes/web.php:2632
...
/**
* @see routes/web.php:2654
* @see routes/web.php:2636
...
/**
* @see routes/web.php:2658
* @see routes/web.php:2640
...
/**
* @see \App\Http\Controllers\Farmasi\PenjualanController::penjualanObat
...
/**
* @see \App\Http\Controllers\Farmasi\SetLokasiController::setLokasi
* @see app/Http/Controllers/Farmasi/SetLokasiController.php:16
* @route '/farmasi/set-lokasi'
*/
export const setLokasi = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: setLokasi.url(options),
    method: 'get',
})

setLokasi.definition = {
    methods: ["get","head"],
...
* @route '/farmasi/set-lokasi'
*/
setLokasi.url = (options?: RouteQueryOptions) => {
    return setLokasi.definition.url + queryParams(options)
}
...
* @route '/farmasi/set-lokasi'
*/
setLokasi.get = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: setLokasi.url(options),
    method: 'get',
})
...
* @route '/farmasi/set-lokasi'
*/
setLokasi.head = (options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: setLokasi.url(options),
    method: 'head',
})

/**
* @see routes/web.php:2692
* @see routes/web.php:2674
...
/**
* @see routes/web.php:2697
* @see routes/web.php:2679
...
/**
* @see routes/web.php:2714
* @see routes/web.php:2696
...
/**
* @see routes/web.php:2717
* @see routes/web.php:2699
...
/**
* @see routes/web.php:2720
* @see routes/web.php:2702
...
/**
* @see routes/web.php:2725
* @see routes/web.php:2707
...
/**
* @see routes/web.php:2730
* @see routes/web.php:2712
...
/**
* @see routes/web.php:2733
* @see routes/web.php:2715
...
/**
* @see routes/web.php:2744
* @see routes/web.php:2726
...
/**
* @see routes/web.php:2757
* @see routes/web.php:2739
...
const farmasi = {
    fastMoving: Object.assign(fastMoving, fastMoving53c06f),
    resep_dokter: Object.assign(resep_dokter, resep_dokter),
    index: Object.assign(index, index),
    dashboard: Object.assign(dashboard, dashboard),
    pembelianObat: Object.assign(pembelianObat, pembelianObat),
    hutangObat: Object.assign(hutangObat, hutangObat2cda7d),
    penjualanObat: Object.assign(penjualanObat, penjualanObat),
    penjualan: Object.assign(penjualan, penjualan),
    setLokasi: Object.assign(setLokasi, setLokasi5fb3bc),
    ...
    farmasi: Object.assign(farmasiModule, farmasiModule),
