...
* @see app/Http/Controllers/PatientController.php:39
* @route '/patients'
*/
...
* @see app/Http/Controllers/PatientController.php:100
...
* @see app/Http/Controllers/PatientController.php:332
...
* @see app/Http/Controllers/PatientController.php:342
* @route '/patients/{patient}'
*/
...
* @see app/Http/Controllers/PatientController.php:547
* @route '/patients/{patient}'
*/
...
* @see app/Http/Controllers/PatientController.php:582
