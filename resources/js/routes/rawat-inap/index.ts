...
import catatanKeperawatanRanap2c56c3 from './catatan-keperawatan-ranap'
/**
...
/**
* @see \App\Http\Controllers\RawatInapController::catatanKeperawatan
* @see app/Http/Controllers/RawatInapController.php:297
* @route '/rawat-inap/catatan-keperawatan'
*/
export const catatanKeperawatan = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: catatanKeperawatan.url(options),
    method: 'get',
})

catatanKeperawatan.definition = {
    methods: ["get","head"],
...
* @route '/rawat-inap/catatan-keperawatan'
*/
catatanKeperawatan.url = (options?: RouteQueryOptions) => {
    return catatanKeperawatan.definition.url + queryParams(options)
}
...
* @route '/rawat-inap/catatan-keperawatan'
*/
catatanKeperawatan.get = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: catatanKeperawatan.url(options),
    method: 'get',
})
...
* @route '/rawat-inap/catatan-keperawatan'
*/
catatanKeperawatan.head = (options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: catatanKeperawatan.url(options),
    method: 'head',
})
...
export const obatRanap = (args: { no_rawat: string | number } | [no_rawat: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: obatRanap.url(args, options),
    method: 'get',
})

obatRanap.definition = {
    methods: ["get","head"],
...
obatRanap.url = (args: { no_rawat: string | number } | [no_rawat: string | number ] | string | number, options?: RouteQueryOptions) => {
    ...
    return obatRanap.definition.url
...
const rawatInap = {
    ...
    catatanKeperawatanRanap: Object.assign(catatanKeperawatanRanap, catatanKeperawatanRanap2c56c3),
    obatRanap: Object.assign(obatRanap, obatRanap),
