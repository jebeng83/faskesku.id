        ...
        >
            ...
            {viewRoute && (
                <DropdownItem
                    onClick={() => {
                        const param =
                            item?.id ?? item?.nik ?? item?.no_rawat ?? item;
                        // Jika param adalah objek, fallback ke query agar aman
                        if (typeof param === "object") {
                            window.location.href = route(viewRoute, {
                                noRawat: param?.no_rawat ?? "",
                            });
                        } else {
                ...
                <DropdownItem
                    onClick={() => {
                        const param =
                            item?.id ?? item?.nik ?? item?.no_rawat ?? item;
                        if (typeof param === "object") {
                            window.location.href = route(editRoute, {
                                noRawat: param?.no_rawat ?? "",
                            });
                        } else {
