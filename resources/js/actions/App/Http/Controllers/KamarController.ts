...
* @see app/Http/Controllers/KamarController.php:280
* @route '/api/kamar'
*/
...
* @see app/Http/Controllers/KamarController.php:326
* @route '/api/kamar'
*/
...
* @see app/Http/Controllers/KamarController.php:346
...
* @see app/Http/Controllers/KamarController.php:367
* @route '/api/kamar/{kd_kamar}'
*/
