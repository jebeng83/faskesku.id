 ...
 * @see app/Http/Controllers/RawatInapController.php:13
 * @route '/rawat-inap'
 */
 ...
 * @see app/Http/Controllers/RawatInapController.php:23
 ...
 * @see app/Http/Controllers/RawatInapController.php:33
 * @route '/rawat-inap'
 */
 ...
 * @see app/Http/Controllers/RawatInapController.php:43
 ...
 * @see app/Http/Controllers/RawatInapController.php:53
 ...
 * @see app/Http/Controllers/RawatInapController.php:63
 * @route '/rawat-inap/{rawat_inap}'
 */
 ...
 * @see app/Http/Controllers/RawatInapController.php:73
 * @route '/rawat-inap/{rawat_inap}'
 */
...
const RawatInapController = { index, create, store, show, edit, update, destroy }
