...
/**
* @see \App\Http\Controllers\Akutansi\PaymentPointController::setModalAwal
* @see app/Http/Controllers/Akutansi/PaymentPointController.php:152
* @route '/api/payment-point/modal-awal'
*/
export const setModalAwal = (options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: setModalAwal.url(options),
    method: 'post',
})

setModalAwal.definition = {
    methods: ["post"],
...
* @route '/api/payment-point/modal-awal'
*/
setModalAwal.url = (options?: RouteQueryOptions) => {
    return setModalAwal.definition.url + queryParams(options)
}
...
* @route '/api/payment-point/modal-awal'
*/
setModalAwal.post = (options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: setModalAwal.url(options),
    method: 'post',
})
...
const PaymentPointController = { index, setModalAwal, report }
