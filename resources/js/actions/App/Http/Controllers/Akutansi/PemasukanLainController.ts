...
/**
* @see \App\Http\Controllers\Akutansi\PemasukanLainController::generateNoMasuk
* @see app/Http/Controllers/Akutansi/PemasukanLainController.php:25
* @route '/api/akutansi/pemasukan-lain/generate-no'
*/
export const generateNoMasuk = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: generateNoMasuk.url(options),
    method: 'get',
})

generateNoMasuk.definition = {
    methods: ["get","head"],
...
* @route '/api/akutansi/pemasukan-lain/generate-no'
*/
generateNoMasuk.url = (options?: RouteQueryOptions) => {
    return generateNoMasuk.definition.url + queryParams(options)
}
...
* @route '/api/akutansi/pemasukan-lain/generate-no'
*/
generateNoMasuk.get = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: generateNoMasuk.url(options),
    method: 'get',
})
...
* @route '/api/akutansi/pemasukan-lain/generate-no'
*/
generateNoMasuk.head = (options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: generateNoMasuk.url(options),
    method: 'head',
})

const PemasukanLainController = { index, describe, store, update, destroy, generateNoMasuk }

export default PemasukanLainController