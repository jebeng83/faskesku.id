...
* @see app/Http/Controllers/DaftarTarifController.php:110
...
* @see app/Http/Controllers/DaftarTarifController.php:129
* @route '/daftar-tarif'
*/
...
* @see app/Http/Controllers/DaftarTarifController.php:196
...
* @see app/Http/Controllers/DaftarTarifController.php:232
* @route '/daftar-tarif/{daftar_tarif}'
*/
...
* @see app/Http/Controllers/DaftarTarifController.php:301
* @route '/daftar-tarif/{daftar_tarif}'
*/
...
const DaftarTarifController = { generateKode, index, create, store, show, edit, update, destroy }
