...
* @see app/Http/Controllers/Pcare/PcareController.php:2759
...
* @see app/Http/Controllers/Pcare/PcareController.php:2304
...
* @see app/Http/Controllers/Pcare/PcareController.php:2883
...
* @see app/Http/Controllers/Pcare/PcareController.php:2934
...
* @see app/Http/Controllers/Pcare/PcareController.php:3003
...
* @see app/Http/Controllers/Pcare/PcareController.php:3020
...
* @see app/Http/Controllers/Pcare/PcareController.php:3580
...
* @see app/Http/Controllers/Pcare/PcareController.php:3649
...
* @see app/Http/Controllers/Pcare/PcareController.php:3664
...
* @see app/Http/Controllers/Pcare/PcareController.php:3712
...
* @see app/Http/Controllers/Pcare/PcareController.php:3680
...
* @see app/Http/Controllers/Pcare/PcareController.php:4054
...
* @see app/Http/Controllers/Pcare/PcareController.php:4074
...
* @see app/Http/Controllers/Pcare/PcareController.php:2604
* @route '/api/pcare/pendaftaran'
*/
...
/**
* @see \App\Http\Controllers\Pcare\PcareController::getPendaftaranByRawatQuery
* @see app/Http/Controllers/Pcare/PcareController.php:2285
* @route '/api/pcare/pendaftaran/rawat'
*/
export const getPendaftaranByRawatQuery = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: getPendaftaranByRawatQuery.url(options),
    method: 'get',
})

getPendaftaranByRawatQuery.definition = {
    methods: ["get","head"],
...
* @route '/api/pcare/pendaftaran/rawat'
*/
getPendaftaranByRawatQuery.url = (options?: RouteQueryOptions) => {
    return getPendaftaranByRawatQuery.definition.url + queryParams(options)
}
...
* @route '/api/pcare/pendaftaran/rawat'
*/
getPendaftaranByRawatQuery.get = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: getPendaftaranByRawatQuery.url(options),
    method: 'get',
})
...
* @route '/api/pcare/pendaftaran/rawat'
*/
getPendaftaranByRawatQuery.head = (options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: getPendaftaranByRawatQuery.url(options),
    method: 'head',
})

/**
* @see \App\Http\Controllers\Pcare\PcareController::getMcu
* @see app/Http/Controllers/Pcare/PcareController.php:3140
* @route '/api/pcare/mcu/kunjungan/{noKunjungan}'
*/
export const getMcu = (args: { noKunjungan: string | number } | [noKunjungan: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: getMcu.url(args, options),
    method: 'get',
})
...
* @route '/api/pcare/mcu/kunjungan/{noKunjungan}'
*/
getMcu.url = (args: { noKunjungan: string | number } | [noKunjungan: string | number ] | string | number, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
...
* @route '/api/pcare/mcu/kunjungan/{noKunjungan}'
*/
getMcu.get = (args: { noKunjungan: string | number } | [noKunjungan: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: getMcu.url(args, options),
    method: 'get',
})
...
* @route '/api/pcare/mcu/kunjungan/{noKunjungan}'
*/
getMcu.head = (args: { noKunjungan: string | number } | [noKunjungan: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: getMcu.url(args, options),
    method: 'head',
})

/**
* @see \App\Http\Controllers\Pcare\PcareController::addMcu
* @see app/Http/Controllers/Pcare/PcareController.php:3036
* @route '/api/pcare/mcu'
*/
export const addMcu = (options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: addMcu.url(options),
    method: 'post',
})
...
* @route '/api/pcare/mcu'
*/
addMcu.url = (options?: RouteQueryOptions) => {
    return addMcu.definition.url + queryParams(options)
}
...
* @route '/api/pcare/mcu'
*/
addMcu.post = (options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: addMcu.url(options),
    method: 'post',
})
...
* @see app/Http/Controllers/Pcare/PcareController.php:3215
...
/**
* @see \App\Http\Controllers\Pcare\PcareController::getProlanisDm
* @see app/Http/Controllers/Pcare/PcareController.php:3314
* @route '/api/pcare/prolanis/dm/{nomorPeserta}/{start}/{limit}'
*/
export const getProlanisDm = (args: { nomorPeserta: string | number, start: string | number, limit: string | number } | [nomorPeserta: string | number, start: string | number, limit: string | number ], options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: getProlanisDm.url(args, options),
    method: 'get',
})

getProlanisDm.definition = {
    methods: ["get","head"],
...
* @route '/api/pcare/prolanis/dm/{nomorPeserta}/{start}/{limit}'
*/
getProlanisDm.url = (args: { nomorPeserta: string | number, start: string | number, limit: string | number } | [nomorPeserta: string | number, start: string | number, limit: string | number ], options?: RouteQueryOptions) => {
    if (Array.isArray(args)) {
        args = {
            nomorPeserta: args[0],
            start: args[1],
    ...
    return getProlanisDm.definition.url
            .replace('{nomorPeserta}', parsedArgs.nomorPeserta.toString())
            .replace('{start}', parsedArgs.start.toString())
            .replace('{limit}', parsedArgs.limit.toString())
            .replace(/\/+$/, '') + queryParams(options)
...
* @route '/api/pcare/prolanis/dm/{nomorPeserta}/{start}/{limit}'
*/
getProlanisDm.get = (args: { nomorPeserta: string | number, start: string | number, limit: string | number } | [nomorPeserta: string | number, start: string | number, limit: string | number ], options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: getProlanisDm.url(args, options),
    method: 'get',
})
...
* @route '/api/pcare/prolanis/dm/{nomorPeserta}/{start}/{limit}'
*/
getProlanisDm.head = (args: { nomorPeserta: string | number, start: string | number, limit: string | number } | [nomorPeserta: string | number, start: string | number, limit: string | number ], options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: getProlanisDm.url(args, options),
    method: 'head',
})

/**
* @see \App\Http\Controllers\Pcare\PcareController::getProlanisHt
* @see app/Http/Controllers/Pcare/PcareController.php:3448
* @route '/api/pcare/prolanis/ht/{nomorPeserta}/{start}/{limit}'
*/
export const getProlanisHt = (args: { nomorPeserta: string | number, start: string | number, limit: string | number } | [nomorPeserta: string | number, start: string | number, limit: string | number ], options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: getProlanisHt.url(args, options),
    method: 'get',
})

getProlanisHt.definition = {
    methods: ["get","head"],
...
* @route '/api/pcare/prolanis/ht/{nomorPeserta}/{start}/{limit}'
*/
getProlanisHt.url = (args: { nomorPeserta: string | number, start: string | number, limit: string | number } | [nomorPeserta: string | number, start: string | number, limit: string | number ], options?: RouteQueryOptions) => {
    if (Array.isArray(args)) {
        args = {
            nomorPeserta: args[0],
            start: args[1],
    ...
    return getProlanisHt.definition.url
            .replace('{nomorPeserta}', parsedArgs.nomorPeserta.toString())
            .replace('{start}', parsedArgs.start.toString())
            .replace('{limit}', parsedArgs.limit.toString())
            .replace(/\/+$/, '') + queryParams(options)
...
* @route '/api/pcare/prolanis/ht/{nomorPeserta}/{start}/{limit}'
*/
getProlanisHt.get = (args: { nomorPeserta: string | number, start: string | number, limit: string | number } | [nomorPeserta: string | number, start: string | number, limit: string | number ], options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: getProlanisHt.url(args, options),
    method: 'get',
})
...
* @route '/api/pcare/prolanis/ht/{nomorPeserta}/{start}/{limit}'
*/
getProlanisHt.head = (args: { nomorPeserta: string | number, start: string | number, limit: string | number } | [nomorPeserta: string | number, start: string | number, limit: string | number ], options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: getProlanisHt.url(args, options),
    method: 'head',
})
...
* @see app/Http/Controllers/Pcare/PcareController.php:1489
...
* @see app/Http/Controllers/Pcare/PcareController.php:2221
...
* @see app/Http/Controllers/Pcare/PcareController.php:4519
...
* @see app/Http/Controllers/Pcare/PcareController.php:4498
...
* @see app/Http/Controllers/Pcare/PcareController.php:4540
...
* @see app/Http/Controllers/Pcare/PcareController.php:4560
...
* @see app/Http/Controllers/Pcare/PcareController.php:4577
* @route '/pcare/api/mapping/poli'
*/
...
* @see app/Http/Controllers/Pcare/PcareController.php:4638
* @route '/pcare/api/mapping/poli'
*/
...
* @see app/Http/Controllers/Pcare/PcareController.php:4688
...
* @see app/Http/Controllers/Pcare/PcareController.php:4705
* @route '/pcare/api/mapping/dokter'
*/
...
* @see app/Http/Controllers/Pcare/PcareController.php:4766
* @route '/pcare/api/mapping/dokter'
*/
...
* @see app/Http/Controllers/Pcare/PcareController.php:4816
...
* @see app/Http/Controllers/Pcare/PcareController.php:4832
* @route '/pcare/api/mapping/obat'
*/
...
* @see app/Http/Controllers/Pcare/PcareController.php:4893
* @route '/pcare/api/mapping/obat'
*/
...
* @see app/Http/Controllers/Pcare/PcareController.php:3731
...
/**
* @see \App\Http\Controllers\Pcare\PcareController::getDetailPesertaSrk
* @see app/Http/Controllers/Pcare/PcareController.php:3913
* @route '/pcare/api/srk/peserta'
*/
const getDetailPesertaSrk851219a2c081af1cf88d928caa382adc = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: getDetailPesertaSrk851219a2c081af1cf88d928caa382adc.url(options),
    method: 'get',
})

getDetailPesertaSrk851219a2c081af1cf88d928caa382adc.definition = {
    methods: ["get","head"],
...
* @route '/pcare/api/srk/peserta'
*/
getDetailPesertaSrk851219a2c081af1cf88d928caa382adc.url = (options?: RouteQueryOptions) => {
    return getDetailPesertaSrk851219a2c081af1cf88d928caa382adc.definition.url + queryParams(options)
}
...
* @route '/pcare/api/srk/peserta'
*/
getDetailPesertaSrk851219a2c081af1cf88d928caa382adc.get = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: getDetailPesertaSrk851219a2c081af1cf88d928caa382adc.url(options),
    method: 'get',
})
...
* @route '/pcare/api/srk/peserta'
*/
getDetailPesertaSrk851219a2c081af1cf88d928caa382adc.head = (options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: getDetailPesertaSrk851219a2c081af1cf88d928caa382adc.url(options),
    method: 'head',
})
...
*/
const getDetailPesertaSrkb12b48d1ab1aeebe25e976cf38ae6d9a = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: getDetailPesertaSrkb12b48d1ab1aeebe25e976cf38ae6d9a.url(options),
    method: 'get',
})

getDetailPesertaSrkb12b48d1ab1aeebe25e976cf38ae6d9a.definition = {
    methods: ["get","head"],
...
* @route '/pcare/api/srk/peserta/test'
*/
getDetailPesertaSrkb12b48d1ab1aeebe25e976cf38ae6d9a.url = (options?: RouteQueryOptions) => {
    return getDetailPesertaSrkb12b48d1ab1aeebe25e976cf38ae6d9a.definition.url + queryParams(options)
}
...
* @route '/pcare/api/srk/peserta/test'
*/
getDetailPesertaSrkb12b48d1ab1aeebe25e976cf38ae6d9a.get = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: getDetailPesertaSrkb12b48d1ab1aeebe25e976cf38ae6d9a.url(options),
    method: 'get',
})
...
* @route '/pcare/api/srk/peserta/test'
*/
getDetailPesertaSrkb12b48d1ab1aeebe25e976cf38ae6d9a.head = (options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: getDetailPesertaSrkb12b48d1ab1aeebe25e976cf38ae6d9a.url(options),
    method: 'head',
})

export const getDetailPesertaSrk = {
    '/pcare/api/srk/peserta': getDetailPesertaSrk851219a2c081af1cf88d928caa382adc,
    '/pcare/api/srk/peserta/test': getDetailPesertaSrkb12b48d1ab1aeebe25e976cf38ae6d9a,
}

/**
* @see \App\Http\Controllers\Pcare\PcareController::pesertaByNik
* @see app/Http/Controllers/Pcare/PcareController.php:4096
...
* @see app/Http/Controllers/Pcare/PcareController.php:659
...
* @see app/Http/Controllers/Pcare/PcareController.php:1579
...
* @see app/Http/Controllers/Pcare/PcareController.php:1676
...
* @see app/Http/Controllers/Pcare/PcareController.php:1648
...
* @see app/Http/Controllers/Pcare/PcareController.php:1926
...
* @see app/Http/Controllers/Pcare/PcareController.php:2029
...
* @see app/Http/Controllers/Pcare/PcareController.php:1797
...
* @see app/Http/Controllers/Pcare/PcareController.php:1876
...
* @see app/Http/Controllers/Pcare/PcareController.php:2189
...
* @see app/Http/Controllers/Pcare/PcareController.php:2200
...
* @see app/Http/Controllers/Pcare/PcareController.php:486
...
* @see app/Http/Controllers/Pcare/PcareController.php:4121
...
* @see app/Http/Controllers/Pcare/PcareController.php:4160
...
* @see app/Http/Controllers/Pcare/PcareController.php:4202
...
* @see app/Http/Controllers/Pcare/PcareController.php:4290
* @route '/pcare/api/kelompok/kegiatan'
*/
...
* @see app/Http/Controllers/Pcare/PcareController.php:4380
...
* @see app/Http/Controllers/Pcare/PcareController.php:4443
...
* @see app/Http/Controllers/Pcare/PcareController.php:4409
...
* @see app/Http/Controllers/Pcare/PcareController.php:4469
...
const PcareController = { getDiagnosa, addPendaftaran, getPendaftaranByRawat, ping, proxy, getDokter, getFaskes, getPoli, getKesadaran, getDpho, getTindakan, getProvider, getSpesialis, getSubSpesialis, getSarana, getKhusus, getPrognosa, getAlergi, getStatusPulang, getFaskesRujukanSubSpesialis, pesertaByNoKartu, deletePendaftaran, getPendaftaranByRawatQuery, getMcu, addMcu, getSkriningPeserta, getProlanisDm, getProlanisHt, getRujukanSubspesialisByRawat, getKabupatenConfig, searchDokterRs, searchPoliklinikRs, cetakRujukan, searchObatRs, getMappingPoli, storeMappingPoli, deleteMappingPoli, getMappingDokter, storeMappingDokter, deleteMappingDokter, getMappingObat, storeMappingObat, deleteMappingObat, getReferensiSrk, getDetailPesertaSrk, pesertaByNik, kirimKunjunganSehat, monitoringSummary, monitoringAttempts, pendaftaranSummary, pendaftaranList, monitoringRaw, bpjsLogList, bpjsLogByRawat, resendByNoRawat, massSend, getPeserta, getClubProlanis, getKegiatanKelompok, addKegiatanKelompok, updateKegiatanKelompok, deleteKegiatanKelompok, getPesertaKegiatan, addPesertaKegiatan, deletePesertaKegiatan }
