...
const PremiumModuleController = { index, create, store, show, edit, update, destroy, generateLicense, activate, deactivate, status, validateLicense }

export default PremiumModuleController