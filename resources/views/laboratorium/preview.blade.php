...
<head>
    ...
    <title>Preview Hasil Pemeriksaan Laboratorium - {{ $permintaanLab['noorder'] ?? '-' }}</title>
    <style>
        @page {
            size: A4 portrait;
            margin: 15mm;
...
<body>
    <div class="preview-container">
        ...
        <div class="action-bar">
            <h2>Preview Hasil Pemeriksaan Laboratorium</h2>
            <div class="action-buttons">
                ...
                <a href="{{ route('laboratorium.permintaan-lab.cetak', ['permintaan_lab' => $noorder]) }}"
        ...
        <div class="signature-section">
            ...
            <div class="signature-right">
                ...
                <div class="signature-box">
                    {{ $periksaLab['dokterPj']['nm_dokter'] ?? $permintaanLab['dokter']['nm_dokter'] ??
                    '________________' }}
                </div>
            </div>
        </div>
