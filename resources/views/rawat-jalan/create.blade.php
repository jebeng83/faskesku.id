...
@section('title', 'Tambah Data Rawat Jalan')
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Tambah Data Rawat Jalan</h3>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control @error('tgl_registrasi') is-invalid @enderror" 
                                           ...
                                           value="{{ old('tgl_registrasi', date('Y-m-d')) }}" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="time" class="form-control @error('jam_reg') is-invalid @enderror" 
                                           ...
                                           value="{{ old('jam_reg', date('H:i')) }}" required>
                                    @error('jam_reg')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('almt_pj') is-invalid @enderror" 
                                              id="almt_pj" name="almt_pj" rows="3">{{ old('almt_pj') }}</textarea>
                                    @error('almt_pj')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control @error('biaya_reg') is-invalid @enderror" 
                                           ...
                                           value="{{ old('biaya_reg') }}" step="0.01" min="0">
                                    @error('biaya_reg')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('stts') is-invalid @enderror" 
                                        ...
                                        @foreach($statusOptions as $key => $value)
                                            <option value="{{ $key }}" {{ old('stts') == $key ? 'selected' : '' }}>
                                                {{ $value }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('stts_daftar') is-invalid @enderror" 
                                        ...
                                        @foreach($statusDaftarOptions as $key => $value)
                                            <option value="{{ $key }}" {{ old('stts_daftar', '-') == $key ? 'selected' : '' }}>
                                                {{ $value }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('status_lanjut') is-invalid @enderror" 
                                        ...
                                        @foreach($statusLanjutOptions as $key => $value)
                                            <option value="{{ $key }}" {{ old('status_lanjut', 'Ralan') == $key ? 'selected' : '' }}>
                                                {{ $value }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('status_bayar') is-invalid @enderror" 
                                        ...
                                        @foreach($statusBayarOptions as $key => $value)
                                            <option value="{{ $key }}" {{ old('status_bayar', 'Belum Bayar') == $key ? 'selected' : '' }}>
                                                {{ $value }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('status_poli') is-invalid @enderror" 
                                        ...
                                        @foreach($statusPoliOptions as $key => $value)
                                            <option value="{{ $key }}" {{ old('status_poli', 'Baru') == $key ? 'selected' : '' }}>
                                                {{ $value }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('sttsumur') is-invalid @enderror" 
                                        ...
                                        @foreach($sttsumurOptions as $key => $value)
                                            <option value="{{ $key }}" {{ old('sttsumur') == $key ? 'selected' : '' }}>
                                                {{ $value }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('keputusan') is-invalid @enderror" 
                                        ...
                                        @foreach($keputusanOptions as $key => $value)
                                            <option value="{{ $key }}" {{ old('keputusan', '-') == $key ? 'selected' : '' }}>
                                                {{ $value }}
                                            </option>
                                        @endforeach
                                    </select>
