...
<head>
    <meta charset="UTF-8">
    <title>Laporan Kunjungan Rawat Jalan</title>
    <style>
...
<body>
    <div class="header">
        <div class="title">LAPORAN KUNJUNGAN RAWAT JALAN</div>
...
<<<<<<< HEAD
                        ...
                        <tr>
                            <td style="padding-right:12px;">Kunjungan Baru : <strong>{{ number_format($summary['baru'] ?? 0) }}</strong></td>
...
<<<<<<< HEAD
                ...
                <th class="nowrap" style="width: 23%">Alamat</th>
